...
function getRecipes(values, queryString){
    $.ajax({
        ...
        for (var i = 0; i < array.length; i++) {
            ...
            caloriesDiv.append("<h3>Calories: " + calories + "</h3>");
            ...
            if (cautions.length == 0) {
                ...
                var cautionsList = $("<ul class='caution_list'><h3>Cautions</h3></ul>");
                for (var c = 0; c < cautions.length; c++) {
                    cautionsList.append("<li><h6>" + cautions[c] + "</h6></li>");
                };
            ...
            for (var label = 0; label < dietLabels.length; label++) {
                dietLabelsList.append("<li><h6>" + dietLabels[label] + "</h6></li>");
            };
            ...
            for (var hLabels = 0; hLabels < healthLabels.length; hLabels++) {
                healthLabelsList.append("<li><h6>" + healthLabels[hLabels] + "</h6></li>");
            };
            ...
            for (var ingredient = 0; ingredient < ingredients.length; ingredient++) {
                ingredientsList.append("<li><h6>" + ingredients[ingredient] + "</h6></li>");
            };
            ...
            for (var t = 0; t < shoppingList.length; t++) {
                shopListWithHeader.append("<li><h6>" + shoppingList[t] + "</h6></li>");
            };
